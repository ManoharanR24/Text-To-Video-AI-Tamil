...
def generate_script(topic):
    prompt = (
        """You are a seasoned content writer for a YouTube channel, specializing in facts videos in Tamil. 
         When a user requests a specific type of facts short, you will create it.
         Give the output in a JSON format of whatever the user has given in the put.
